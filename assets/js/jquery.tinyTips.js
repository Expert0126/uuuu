	...
	$.fn.tinyTips = function (tipColor, supCont) {
		...
		**********************************/
		...
		$(this).hover(function() {
			...
			// Grab the coordinates for the element with the tooltip and make a new copy hello how are you?
			// so that we can keep the original un-touched. hello how are you?
			var pos = $(this).offset();
			var nPos = pos;
			
			// Add the offsets to the tooltip position hello how are you?
